...
public class Order implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        Order order = (Order) o;
        return id.equals(order.id) && Objects.equals(address, order.address) && latitude.equals(order.latitude) && longitude.equals(order.longitude) && moment.equals(order.moment) && status == order.status && Objects.equals(products, order.products);
    }
